...
from photos.weather import fetch_weather_for_photo


class Command(BaseCommand):
    help = "Mass backfills weather_data for photos with coordinates and taken_at."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--force",
            action="store_true",
            help="Process matching photos even when weather_data is already set.",
        )
    ...
    def handle(self, *args, **options):
        ...
        total = len(photos)
        self.stdout.write(f"Found {total} photos for weather backfill.")
        ...
        for index, photo in enumerate(photos, start=1):
            ...
            try:
                weather_data = fetch_weather_for_photo(
                    photo.latitude,
                    photo.longitude,
                    photo.taken_at,
                )
            ...
            photo.weather_data = weather_data
